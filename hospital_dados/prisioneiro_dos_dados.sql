...
--
insert into tipo_quarto(id_tipo, valor_diario, desc_quarto) values(1, '100.00', 'Apartamento');
insert into tipo_quarto(id_tipo, valor_diario, desc_quarto) values(2, '800.00', 'Quartos duplos');
insert into tipo_quarto(id_tipo, valor_diario, desc_quarto) values(3, '300.00', 'Enfermaria');


-- Inserindo dados na tabela Medico
--
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(1, 'Dr octavio', 1472581234, 745896, 'Droctavio@gmail.com', 'Residente', 6); 
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(2, 'Dr werik', '74126956', '123789', 'Drwerik@gmail.com', 'Residente', 7);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(3, 'Dr gustavo ', '78531045', '569745', 'Drgustavo@gmail.com', 'Interno', 1);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(4, 'Dr gabriel', '47965816', '459781', 'Drgabriel@gmail.com', 'Residente', 5);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(5, 'Dr guilherme', '14736985', '123780', 'Drguilherme@hotmail.com', 'Especialista', 6);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(6, 'Dr vitória', '36407814', '014698', 'Drvitória@gmail.com', 'Residente', 2);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(7, 'Dr magal', '12047896', '814362', 'Drmagal@gmail.com', 'Interno', 3);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(8, 'Dr josé', '47158296', '654782', 'Drjosé@gmail.com', 'Especialista', 1);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(9, 'Dr stevam', '47915768', '487127', 'Drstevam@gmail.com', 'Especialista', 2);
insert into medico(id_medico, nome_medico, cpf_medico, crm, email_medico, cargo, especialidade_id) values(10, 'Dr paulo', '78469512', '147548', 'Drpaulo@gmail.com', 'Residente', 4);


-- Inserindo dados na tabela Paciente
--
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(1, 'elizabete bissornia', '1994-08-21', '74951847', '1462085-x', 'elizabete.bissornia@gmail.com', null);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(2, 'rodrigo Silva', '1970-08-21', '87165493', '1459870', 'rodrigo.silva123@gmail.com', 4);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(3, 'jorel dos Santos', '200-01-11', '19874623', '3278451', 'jorel.santos@gmail.com', null);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(4, 'maria', '1997-12-03', '65982365', '8541795', 'maria457@gmail.com', 1);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(5, 'sival de Melo', '2002-05-04', '14785296', '2684197', 'sival.melo@gmail.com', 3);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(6, 'jose wellington Costa', '1985-02-25', '65987436', '145987-x', 'josewellington.costa@gmail.com', 1);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(7, 'Daniel Alves da Silva', '1988-09-01', '65983063', '74859615', 'dani.alves@gmail.com', 2);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(8, 'Santiago santos', '2004-10-16', '85964723', '4569874', 'santiago43@gmail.com', null);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(9, 'maria fernanda', '1970-01-30', '36985269', '25647891', 'maria.fernanda@gmail.com', null);
insert into paciente(id_paciente, nome_paciente, dt_nasc_paciente, cpf_paciente, rg_paciente, email_paciente, convenio_id) values(10, 'Gabriela de Souza', '1999-07-12', '36502178', '12097452', 'gabriela.souza@gmail.com', 2);
...
--
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(1, ' sauo santos', 74851574, '415879');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(2, 'sam condado', 58749617, '254109');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(3, 'frodo bolseiro', 78032145, '012478');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(4, 'dwayne jhonson', 10479547, '960124');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(5, 'patrica santos', 87459612, '784169');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(6, 'lia antunes', 20147896, '894175');
...
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(9, 'naruto', 74198569, '120478');
insert into enfermeiro(id_enfermeiro, nome_enfermeiro, cpf_enfermeiro, cre) values(10, ' jeff grosso', 88742514, '251369');
